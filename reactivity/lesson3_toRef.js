...
function track(target, key) {
  if (activeEffect) {
    ...
    console.log('dep.add(activeEffect)')
...
console.log(
  `Before updated quantity total (should be 10) = ${total} salePrice (should be 4.5) = ${salePrice.value}`
)

product.price = 3
// console.log('salePrice.value',  salePrice.value)
// console.log(
